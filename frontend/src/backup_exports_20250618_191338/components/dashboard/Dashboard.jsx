...
const Dashboard = ({ onboardingData, transactions, onNavigate }) => {
  ...
  const handleMenuAction = (actionId) => {
    ...
    switch (actionId) {
      ...
      case 'start-next-period':
        ...
        break;
      case 'export':
        // Handle export functionality if implemented
  ...
  const dashboardData = {
    household: onboardingData?.householdName || 'Your Budget',
    period: onboardingData?.periodDuration ? 
      `${onboardingData.periodDuration}-month budget period` : 
      'Budget Period',
    thisMonth: {
      spent: 2847,
      budget: 3200,
